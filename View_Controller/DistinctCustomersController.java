 ...
 */
public class DistinctCustomersController implements Initializable {
    
//    public static ObservableList<Appointment> appointmentDescription = FXCollections.observableArrayList();
    String sqlAppt = "SELECT count(distinct customerId) FROM appointment WHERE start LIKE ?";
    ...
    public DistinctCustomersController()throws SQLException, IOException{
